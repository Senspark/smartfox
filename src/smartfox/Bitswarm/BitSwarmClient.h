...
// Class BitSwarmClient
// -------------------------------------------------------------------
class BitSwarmClient : public IDispatchable,
                       public boost::enable_shared_from_this<BitSwarmClient> {
public:
    // -------------------------------------------------------------------
    // Public methods
    // -------------------------------------------------------------------
    ...
    virtual ~BitSwarmClient() override;
    ...
    boost::shared_ptr<std::string> ConnectionIp();
    long int ConnectionPort();
    void Connect();
    void Connect(const boost::shared_ptr<std::string>& ip,
                 unsigned short int port);
    void Send(boost::shared_ptr<IMessage> message);
    void Disconnect();
    void Disconnect(const boost::shared_ptr<std::string>& reason);
...
private:
    ...
    static void OnBBConnect(unsigned long long context,
                            boost::shared_ptr<BaseEvent> e);
    static void OnBBData(unsigned long long context,
                         boost::shared_ptr<BaseEvent> e);
    static void OnBBDisconnect(unsigned long long context,
                               boost::shared_ptr<BaseEvent> e);
    static void OnBBError(unsigned long long context,
                          boost::shared_ptr<BaseEvent> e);
    ...
    static void
    OnSocketData(unsigned long long context,
                 boost::shared_ptr<std::vector<unsigned char>> data);
    static void OnSocketError(unsigned long long context,
    ...
    boost::shared_ptr<boost::asio::deadline_timer>
        retryTimer; // Boost Asio deadline timer
