...
// Debug
// -------------------------------------------------------------------
void Logger::Debug(boost::shared_ptr<std::vector<std::string>> messages) 
{ 
	boost::shared_ptr<std::string> log (new std::string());
...
// Info
// -------------------------------------------------------------------
void Logger::Info(boost::shared_ptr<std::vector<std::string>> messages) 
{ 
	boost::shared_ptr<std::string> log (new std::string());
...
// Warn
// -------------------------------------------------------------------
void Logger::Warn(boost::shared_ptr<std::vector<std::string>> messages) 
{ 
	boost::shared_ptr<std::string> log (new std::string());
...
// Error
// -------------------------------------------------------------------
void Logger::Error(boost::shared_ptr<std::vector<std::string>> messages) 
{
	boost::shared_ptr<std::string> log (new std::string());
...
// Log
// -------------------------------------------------------------------
void Logger::Log(LogLevel level, boost::shared_ptr<std::string> message)
{
