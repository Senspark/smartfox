...
namespace Logging {
	...
	public:
		...
		*/
		...
		void Debug(boost::shared_ptr<std::vector<std::string>> messages);
		void Info(boost::shared_ptr<std::vector<std::string>> messages);
		void Warn(boost::shared_ptr<std::vector<std::string>> messages);
		void Error(boost::shared_ptr<std::vector<std::string>> messages);
	...
	private:
		...
		void Log(LogLevel level, boost::shared_ptr<std::string> message);
