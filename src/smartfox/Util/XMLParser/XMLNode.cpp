...
// GetNodeList
// -------------------------------------------------------------------
boost::shared_ptr<XMLNodeList> XMLNode::GetNodeList(const boost::shared_ptr<std::string>& path)
{
...
// GetNode
// -------------------------------------------------------------------
boost::shared_ptr<XMLNode> XMLNode::GetNode(const boost::shared_ptr<std::string>& path)
{
...
// GetValue
// -------------------------------------------------------------------
boost::shared_ptr<std::string> XMLNode::GetValue(const boost::shared_ptr<std::string>& path)
{
...
// GetObject
// -------------------------------------------------------------------
boost::shared_ptr<void> XMLNode::GetObject(const boost::shared_ptr<std::string>& path)
{
