...
public:
    ...
    //        A pointer to a function that accepts two parameters and returns a
    //void         It is the callback wrapped by this delegate
    //
    //        context        An optional context
    DelegateTwoArguments(void (*function)(unsigned long long, type1, type2),
...
private:
    ...
    void (*function)(unsigned long long, type1,
                     type2);    // A pointer to a function that accepts two
