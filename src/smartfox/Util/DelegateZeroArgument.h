...
public:
    ...
    DelegateZeroArgument(void (*function)(unsigned long long),
...
private:
    ...
    void (*function)(unsigned long long); // A pointer to a function without
                                          // parameters that returns a void. It
                                          // is the callback wrapped by this
                                          // delegate
