...
public:
    ...
    //        A pointer to a function that accepts three parameters and returns a
    //void         It is the callback wrapped by this delegate
    //
    //        context        An optional context
    DelegateThreeArguments(void (*function)(unsigned long long, type1, type2,
                                            type3),
...
private:
    ...
    void (*function)(unsigned long long, type1, type2,
                     type3);    // A pointer to a function that accepts three
                                // parameters and returns a void. It is the
                                // callback wrapped by this delegate
