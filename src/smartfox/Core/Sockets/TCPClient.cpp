...
// SynchRead
// -------------------------------------------------------------------
boost::shared_ptr<std::vector<unsigned char> > TCPClient::SynchRead ()
{
	size_t length = 0;
	boost::system::error_code error;
...
// AsynchWrite
// -------------------------------------------------------------------
void TCPClient::AsynchWrite (boost::shared_ptr<std::vector<unsigned char> > data, boost::shared_ptr<TCPDataWriteDelegate> callback)
{
	if (this->isDisposed == true)
	{
		return;
...
// SynchWrite
// -------------------------------------------------------------------
void TCPClient::SynchWrite (boost::shared_ptr<std::vector<unsigned char> > data)
{
	if (this->isDisposed == true)
	{
		return;
