...
namespace Sockets {
	...
	public:
		...
		virtual void Write(boost::shared_ptr<std::vector<unsigned char> >);
	...
	private:
		...
		void LogError(const boost::shared_ptr<std::string>& msg);
		void HandleError(const boost::shared_ptr<std::string>& err);
		void HandleError(const boost::shared_ptr<std::string>& err, SocketErrors se);
		static void HandleErrorCallback(unsigned long long context, boost::shared_ptr<void> state);
		void CallOnData(boost::shared_ptr<std::vector<unsigned char> > data);
		void CallOnError(const boost::shared_ptr<std::string>& msg, SocketErrors se);
		void HandleDisconnection();
		void HandleBinaryData(boost::shared_ptr<std::vector<unsigned char> > data);
		void WriteSocket(boost::shared_ptr<std::vector<unsigned char> > data);
		...
		//		context		Optional context
		//		data		Received data
		static void OnSocketDataReceived(unsigned long long context, boost::shared_ptr<std::vector<unsigned char> > data);
