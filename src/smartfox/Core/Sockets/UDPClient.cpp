...
void UDPClient::Connect (boost::shared_ptr<IPAddress> ipAddress, unsigned short int ipPort, long int timeout, boost::shared_ptr<UDPConnectionDelegate> callback)
{
	...
	boost::shared_ptr<std::string> ipPortAsString (new std::string(buffer));
...
// AsynchWrite
// -------------------------------------------------------------------
void UDPClient::AsynchWrite (boost::shared_ptr<std::vector<unsigned char> > data, boost::shared_ptr<UDPDataWriteDelegate> callback)
{
