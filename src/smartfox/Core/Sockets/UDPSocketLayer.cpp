...
// LogWarn
// -------------------------------------------------------------------
void UDPSocketLayer::LogWarn(const boost::shared_ptr<std::string>& msg)
{
    if (log == NULL) return;
    
    boost::shared_ptr<std::vector<std::string>> messages (new std::vector<string>());
...
// LogError
// -------------------------------------------------------------------
void UDPSocketLayer::LogError(const boost::shared_ptr<std::string>& msg)
{
    if (log == NULL) return;
...
// HandleError
// -------------------------------------------------------------------
void UDPSocketLayer::HandleError(const boost::shared_ptr<std::string>& err)
{
...
// HandleError
// -------------------------------------------------------------------
void UDPSocketLayer::HandleError(const boost::shared_ptr<std::string>& err, SocketErrors se)
{
    ...
    boost::shared_ptr<std::string> convertedString (new std::string(converterIntToString.str()));
...
// HandleErrorCallback
// -------------------------------------------------------------------
void UDPSocketLayer::HandleErrorCallback(unsigned long long context,
                                         boost::shared_ptr<void> state) {
    // Map context
    auto instance = reinterpret_cast<UDPSocketLayer*>(context);
...
// WriteSocket
// -------------------------------------------------------------------
void UDPSocketLayer::WriteSocket(boost::shared_ptr<std::vector<unsigned char> > data)
{
    try
    {
    ...
    catch (...)
    {
        ...
        boost::shared_ptr<std::string> message (new std::string("General error writing to socket: "));
        HandleError(message);
    }
}
...
// HandleBinaryData
// -------------------------------------------------------------------
void UDPSocketLayer::HandleBinaryData(boost::shared_ptr<std::vector<unsigned char> > data)
{
    CallOnData(data);
}
...
// CallOnError
// -------------------------------------------------------------------
void UDPSocketLayer::CallOnError(const boost::shared_ptr<std::string>& msg, SocketErrors se)
{
    if (onError != NULL)
    {
...
// CallOnData
// -------------------------------------------------------------------
void UDPSocketLayer::CallOnData(boost::shared_ptr<std::vector<unsigned char> > data)
{
    if (onData != NULL)
    {
        boost::shared_ptr<ThreadManager> manager = bitSwarm->ThreadManager();
...
void UDPSocketLayer::OnSocketConnection(unsigned long long context, SocketErrors code)
{
    ...
    {
        boost::shared_ptr<std::string> message (new std::string("Connection error: "));
...
void UDPSocketLayer::OnSocketDataSent(unsigned long long context, SocketErrors code)
{
    ...
    if (code != SocketErrors_Success)
    {
        boost::shared_ptr<std::string> message (new std::string("Error sending data to remote side over the established connection"));
        instance->HandleError(message, code);
    }
}
...
// -------------------------------------------------------------------
void UDPSocketLayer::OnSocketDataReceived(unsigned long long context, boost::shared_ptr<std::vector<unsigned char> > data)
{
    // Map context
    UDPSocketLayer* instance = (UDPSocketLayer*)context;
...
void UDPSocketLayer::Connect(boost::shared_ptr<IPAddress> address, unsigned short int port)
{
    ...
    {
        boost::shared_ptr<std::string> message (new std::string("General exception on connection: "));
        HandleError(message);
    }
}
...
// Write
// -------------------------------------------------------------------
void UDPSocketLayer::Write(boost::shared_ptr<std::vector<unsigned char> > data)
{
    WriteSocket(data);
}
