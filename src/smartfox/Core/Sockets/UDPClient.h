...
namespace Sockets {
	...
	typedef DelegateOneArgument<boost::shared_ptr<std::vector<unsigned char> > > UDPDataReadDelegate;
	...
	public:
		...
		void AsynchWrite (boost::shared_ptr<std::vector<unsigned char> > data, boost::shared_ptr<UDPDataWriteDelegate> callback);
