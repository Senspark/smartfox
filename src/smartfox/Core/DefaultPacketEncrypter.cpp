...
void DefaultPacketEncrypter::Encrypt(boost::shared_ptr<ByteArray> data)
{
	...
	boost::shared_ptr<std::vector<unsigned char> > dataEncrypted = boost::shared_ptr<std::vector<unsigned char> >(new vector<unsigned char>());
...
void DefaultPacketEncrypter::Decrypt(boost::shared_ptr<ByteArray> data)
{
	...
	boost::shared_ptr<std::vector<unsigned char> > dataDecrypted = boost::shared_ptr<std::vector<unsigned char> >(new vector<unsigned char>());
