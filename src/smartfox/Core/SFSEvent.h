...
namespace Core {
	...
	public:
		...
		// Public methods
		// -------------------------------------------------------------------
		SFSEvent(const boost::shared_ptr<std::string>& type);
		SFSEvent(const boost::shared_ptr<std::string>& type, boost::shared_ptr<map<string, boost::shared_ptr<void> > > data);

		// -------------------------------------------------------------------
		// Public members
		// -------------------------------------------------------------------
		static boost::shared_ptr<std::string> HANDSHAKE;
		...
		static boost::shared_ptr<std::string> UDP_INIT;
		...
		static boost::shared_ptr<std::string> CONNECTION;
		 ...
		 * </table>
		 */
		static boost::shared_ptr<std::string> PING_PONG;
		 ...
		 * </table>
		 */
		static boost::shared_ptr<std::string> SFS_SOCKET_ERROR;
		...
		///			boost::shared_ptr<std::string> message (new std::string("Connection was lost, Reason: " +  *((boost::static_pointer_cast<string>)(ptrEventParamValueReason))));
		///		}
		/// \endcode
		/// </example>
		/// 
		...
		static boost::shared_ptr<std::string> CONNECTION_LOST;
		...
		/// <seealso cref="CONNECTION_RESUME"/>
		/// <seealso cref="CONNECTION"/>
		static boost::shared_ptr<std::string> CONNECTION_RETRY;
		...
		/// <seealso cref="CONNECTION_RESUME"/>
		/// <seealso cref="CONNECTION"/>
		static boost::shared_ptr<std::string> CONNECTION_RESUME;
		 ...
		 * @see		#CONNECTION_LOST
		 */	
		static boost::shared_ptr<std::string> CONNECTION_ATTEMPT_HTTP;
		...
		static boost::shared_ptr<std::string> CONFIG_LOAD_SUCCESS;
		...
		/// <seealso cref="SmartFox.LoadConfig(string, bool)"/>
		static boost::shared_ptr<std::string> CONFIG_LOAD_FAILURE;
		...
		///
		///					boost::shared_ptr<std::string> message (new std::string("Hi, I have just logged in as: " +  ptrNotifiedUser->Name()));
		///				}
		/// 		\endcode
		/// </example>
		/// <seealso cref="LOGIN_ERROR"/>
        /// <seealso cref="Requests.LoginRequest"/>
		static boost::shared_ptr<std::string> LOGIN;
		...
		///					boost::shared_ptr<std::string> ptrNotifiedMessage = ((boost::static_pointer_cast<string>))(ptrEventParamValueMessage);
		///
		///					boost::shared_ptr<std::string> message (new std::string("Login Failed. Reason: " +  *ptrNotifiedMessage));
		///				}
		/// 		\endcode
		/// </example> 
		/// <seealso cref="LOGIN"/>
        /// <seealso cref="Requests.LoginRequest"/>
		static boost::shared_ptr<std::string> LOGIN_ERROR;
        ...
        /// <seealso cref="Requests.LoginRequest"/>
		static boost::shared_ptr<std::string> LOGOUT;
		...
		static boost::shared_ptr<std::string> ROOM_ADD;
		...
		static boost::shared_ptr<std::string> ROOM_REMOVE;
		...
		///					boost::shared_ptr<std::string> message (new std::string("Room Creation Error: " +  *ptrErrorMessage));
		///				}
		/// 		\endcode
		/// </example>
		/// <seealso cref="ROOM_ADD"/>
        /// <seealso cref="Requests.CreateRoomRequest"/>
		static boost::shared_ptr<std::string> ROOM_CREATION_ERROR;
		...
		static boost::shared_ptr<std::string> ROOM_JOIN;
		...
		///					boost::shared_ptr<map<string, boost::shared_ptr<void>>> ptrEventParams = ptrEvent->Params();
		///					boost::shared_ptr<void> ptrEventParamValueErrorMessage = (*ptrEventParams)["errorMessage"];
		///					boost::shared_ptr<std::string> ptrErrorMessage = ((boost::static_pointer_cast<string>))(ptrEventParamValueErrorMessage);
		///					boost::shared_ptr<std::string> message (new std::string("Join Room Failure: " +  *ptrErrorMessage));
		///				}
		/// 		\endcode
		/// </example>
		/// <seealso cref="ROOM_JOIN"/>
        /// <seealso cref="Requests.JoinRoomRequest"/>
		static boost::shared_ptr<std::string> ROOM_JOIN_ERROR;
		...
		/// <seealso cref="ROOM_JOIN"/>
        /// <seealso cref="Requests.JoinRoomRequest"/>
		static boost::shared_ptr<std::string> USER_ENTER_ROOM;
		...
		static boost::shared_ptr<std::string> USER_EXIT_ROOM;
		...
		/// 		\endcode
		/// </example>
		static boost::shared_ptr<std::string> USER_COUNT_CHANGE;
		...
		static boost::shared_ptr<std::string> PUBLIC_MESSAGE;
		...
		static boost::shared_ptr<std::string> PRIVATE_MESSAGE;
		...
		static boost::shared_ptr<std::string> MODERATOR_MESSAGE;
		...
		static boost::shared_ptr<std::string> ADMIN_MESSAGE;
		...
		///					virtual boost::shared_ptr<std::string> dump = obj->GetDump();
		///				}
 		/// 		\endcode
		/// </example>
        /// <seealso cref="Requests.ObjectMessageRequest"/>
 		static boost::shared_ptr<std::string> OBJECT_MESSAGE;
		...
		static boost::shared_ptr<std::string> EXTENSION_RESPONSE;
		...
		static boost::shared_ptr<std::string> ROOM_VARIABLES_UPDATE;
		...
		static boost::shared_ptr<std::string> USER_VARIABLES_UPDATE;
		...
		static boost::shared_ptr<std::string> ROOM_GROUP_SUBSCRIBE;
		...
		static boost::shared_ptr<std::string> ROOM_GROUP_UNSUBSCRIBE;
		...
		/// </remarks>
        /// <seealso cref="Requests.SubscribeRoomGroupRequest"/>
		static boost::shared_ptr<std::string> ROOM_GROUP_SUBSCRIBE_ERROR;
		...
		/// </remarks>
        /// <seealso cref="Requests.UnsubscribeRoomGroupRequest"/>
		static boost::shared_ptr<std::string> ROOM_GROUP_UNSUBSCRIBE_ERROR;
		...
		static boost::shared_ptr<std::string> SPECTATOR_TO_PLAYER;
        ...
        static boost::shared_ptr<std::string> PLAYER_TO_SPECTATOR;
		...
		/// </remarks>
        /// <seealso cref="Requests.SpectatorToPlayerRequest"/>
		static boost::shared_ptr<std::string> SPECTATOR_TO_PLAYER_ERROR;
		...
		/// </remarks>
        /// <seealso cref="Requests.PlayerToSpectatorRequest"/>
		static boost::shared_ptr<std::string> PLAYER_TO_SPECTATOR_ERROR;
		...
		static boost::shared_ptr<std::string> ROOM_NAME_CHANGE;
		...
		/// </remarks>
        /// <seealso cref="Requests.ChangeRoomNameRequest"/>
		static boost::shared_ptr<std::string> ROOM_NAME_CHANGE_ERROR;
		...
		static boost::shared_ptr<std::string> ROOM_PASSWORD_STATE_CHANGE;
		...
		/// </remarks>
        /// <seealso cref="Requests.ChangeRoomPasswordStateRequest"/>
		static boost::shared_ptr<std::string> ROOM_PASSWORD_STATE_CHANGE_ERROR;
		...
		static boost::shared_ptr<std::string> ROOM_CAPACITY_CHANGE;
		...
		/// </remarks>
        /// <seealso cref="Requests.ChangeRoomCapacityRequest"/>
		static boost::shared_ptr<std::string> ROOM_CAPACITY_CHANGE_ERROR;
		...
		static boost::shared_ptr<std::string> ROOM_FIND_RESULT;
		...
		static boost::shared_ptr<std::string> USER_FIND_RESULT;
		...
		static boost::shared_ptr<std::string> INVITATION;
        ...
        /// <seealso cref="Requests.Game.InviteUsersRequest"/>
		static boost::shared_ptr<std::string> INVITATION_REPLY;
		...
		/// <seealso cref="Requests.Game.InviteUsersRequest"/>
		static boost::shared_ptr<std::string> INVITATION_REPLY_ERROR;
		...
		/// \endcode
		/// </example>
		static boost::shared_ptr<std::string> DEBUG_MESSAGE;
		...
		static boost::shared_ptr<std::string> PROXIMITY_LIST_UPDATE;
		...
		/// <seealso cref="Sfs2X.Entities.MMOItem"/>
		/// <seealso cref="Sfs2X.Entities.MMORoom"/>
		static boost::shared_ptr<std::string> MMOITEM_VARIABLES_UPDATE;
		...
		static boost::shared_ptr<std::string> CRYPTO_INIT;
