...
namespace Core {
	...
	public:
		...
		*/
		...
		static boost::shared_ptr<std::string> CONTROLLER_ID;
		static boost::shared_ptr<std::string> ACTION_ID;
		static boost::shared_ptr<std::string> PARAM_ID;
		static boost::shared_ptr<std::string> USER_ID;				// UDP Only
		static boost::shared_ptr<std::string> UDP_PACKET_ID;			// UDP Only
