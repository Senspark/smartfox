...
namespace Core {
	...
	public:
		...
		// Public methods
		// -------------------------------------------------------------------
		SFSBuddyEvent(const boost::shared_ptr<std::string>& type);
		SFSBuddyEvent(const boost::shared_ptr<std::string>& type, boost::shared_ptr<map<string, boost::shared_ptr<void> > > args);
		...
		/// \code{.cpp}
		///		boost::shared_ptr<std::string> message (new std::string("Buddy States: " +  ptrSmartFox->BuddyManager()->BuddyStates()->at(0)));
		/// \endcode
		/// </example>
		/// 
		...
		static boost::shared_ptr<std::string> BUDDY_LIST_INIT;
		...
		static boost::shared_ptr<std::string> BUDDY_ADD;
		...
		static boost::shared_ptr<std::string> BUDDY_REMOVE;
		...
		static boost::shared_ptr<std::string> BUDDY_BLOCK;
		...
		/// </list>
		/// </remarks>
		static boost::shared_ptr<std::string> BUDDY_ERROR;
		...
		static boost::shared_ptr<std::string> BUDDY_ONLINE_STATE_UPDATE;
		...
		static boost::shared_ptr<std::string> BUDDY_VARIABLES_UPDATE;
		...
		static boost::shared_ptr<std::string> BUDDY_MESSAGE;
