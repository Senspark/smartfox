...
namespace Core {
	...
	public:
		...
		BaseEvent();
		BaseEvent(const boost::shared_ptr<std::string>& type);
		BaseEvent(const boost::shared_ptr<std::string>& type, boost::shared_ptr<map<string, boost::shared_ptr<void> > > args);
		~BaseEvent();

		boost::shared_ptr<std::string> Type();
		void Type(const boost::shared_ptr<std::string>& value);
