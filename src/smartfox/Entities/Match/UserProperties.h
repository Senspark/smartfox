...
namespace Match {
	...
	public:
		...
		/// The isPlayer flag
		/// </summary>
		static boost::shared_ptr<std::string> IS_PLAYER;
		
		/// <summary>
		/// The isSpectator flag
		/// </summary>
		static boost::shared_ptr<std::string> IS_SPECTATOR;
		
		/// <summary>
		/// The isNPC flag
		/// </summary>
		static boost::shared_ptr<std::string> IS_NPC;
		
		/// <summary>
		/// The User privilege Id
		/// </summary>
		static boost::shared_ptr<std::string> PRIVILEGE_ID;
		
		/// <summary>
		/// Checks if User.lastJoinedRoom == null, in other words the User is not joined in any Room
		/// </summary>
		static boost::shared_ptr<std::string> IS_IN_ANY_ROOM;
