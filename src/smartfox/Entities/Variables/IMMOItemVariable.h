...
namespace Variables {
/// <summary>
/// The IMMOItemVariable interface defines all the public methods and properties
/// that an object representing a SmartFoxServer MMOItem Variable exposes.
/// </summary>
///
/// <remarks>
/// In the SmartFoxServer 2X client API this interface is implemented by the
/// <see cref="MMOItemVariable"/> class. Read the class description for
