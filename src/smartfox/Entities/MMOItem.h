...
namespace Entities {
	...
	public:
		...
		/// <inheritdoc />
		virtual boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItemVariable> > > GetVariables();
		
		/// <inheritdoc />
		virtual boost::shared_ptr<IMMOItemVariable> GetVariable(const std::string& name);
		
		/// <exclude/>
		virtual void SetVariable(boost::shared_ptr<IMMOItemVariable> variable);
		
		/// <exclude/>
		virtual void SetVariables(boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItemVariable> > > variables);
		
		/// <inheritdoc />
		virtual bool ContainsVariable(const std::string& name);
