...
// Constructor
// -------------------------------------------------------------------
SFSInvitation::SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee)
{
...
// Constructor
// -------------------------------------------------------------------
SFSInvitation::SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer)
{
...
// Constructor
// -------------------------------------------------------------------
SFSInvitation::SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer, boost::shared_ptr<ISFSObject> parameters)
{
...
// Init
// -------------------------------------------------------------------
void SFSInvitation::Init(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer, boost::shared_ptr<ISFSObject> parameters)
{
