...
namespace Invitation {
	...
	public:
		...
		/// </param>
		SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee);
		...
		/// </param>
		SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer);
		...
		/// </param>
		SFSInvitation(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer, boost::shared_ptr<ISFSObject> parameters);
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(const boost::shared_ptr<User>& inviter, boost::shared_ptr<User> invitee, long int secondsForAnswer, boost::shared_ptr<ISFSObject> parameters);
