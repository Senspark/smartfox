...
// Constructor
// -------------------------------------------------------------------
MMORoom::MMORoom (long int id, const std::string& name, const std::string& groupId)
...
// Constructor
// -------------------------------------------------------------------
MMORoom::MMORoom (long int id, const std::string& name)
	: SFSRoom(id, name)
{
	this->defaultAOI = boost::shared_ptr<Vec3D>();
	this->lowerMapLimit = boost::shared_ptr<Vec3D>();
...
// GetMMOItems
// -------------------------------------------------------------------
boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItem> > > MMORoom::GetMMOItems()
{
	boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItem> > > result (new vector<boost::shared_ptr<IMMOItem> >());
