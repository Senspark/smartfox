...
// GetVariables
// -------------------------------------------------------------------
boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItemVariable> > > MMOItem::GetVariables()
{
	boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItemVariable> > > result (new vector<boost::shared_ptr<IMMOItemVariable> >());
...
// GetVariable
// -------------------------------------------------------------------
boost::shared_ptr<IMMOItemVariable> MMOItem::GetVariable(const std::string& name)
{
	map<string, boost::shared_ptr<IMMOItemVariable> >::iterator iterator;
...
// SetVariables
// -------------------------------------------------------------------
void MMOItem::SetVariables(boost::shared_ptr<std::vector<boost::shared_ptr<IMMOItemVariable> > > variables)
{
...
// ContainsVariable
// -------------------------------------------------------------------
bool MMOItem::ContainsVariable(const std::string& name)
{
	map<string, boost::shared_ptr<IMMOItemVariable> >::iterator iterator;
	iterator = variables->find(name);
	if (iterator == variables->end())
