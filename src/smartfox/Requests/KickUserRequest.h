...
namespace Requests {
	...
	public:
		...
		/// <see cref="KickUserRequest(long int, string, long int)"/>
		/// </summary>
		KickUserRequest(long int userId, const std::string& message);
		...
		KickUserRequest(long int userId, const std::string& message, long int delaySeconds);
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(long int userId, const std::string& message, long int delaySeconds);
