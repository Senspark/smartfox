...
namespace Game {
	...
	public:
		...
		///			boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable>>> collectionRoomVariables (new vector<boost::shared_ptr<RoomVariable>>());
		///			boost::shared_ptr<RoomVariable> variable (new SFSRoomVariable("desc", boost::shared_ptr<std::string>(new std::string("Darts game, public, bestScore > 100")), VARIABLETYPE_STRING));
		...
		static boost::shared_ptr<std::string> KEY_IS_PUBLIC;

		static boost::shared_ptr<std::string> KEY_MIN_PLAYERS;

		static boost::shared_ptr<std::string> KEY_INVITED_PLAYERS;

		static boost::shared_ptr<std::string> KEY_SEARCHABLE_ROOMS;

		static boost::shared_ptr<std::string> KEY_PLAYER_MATCH_EXP;

		static boost::shared_ptr<std::string> KEY_SPECTATOR_MATCH_EXP;

		static boost::shared_ptr<std::string> KEY_INVITATION_EXPIRY;

		static boost::shared_ptr<std::string> KEY_LEAVE_ROOM;

		static boost::shared_ptr<std::string> KEY_NOTIFY_GAME_STARTED;

		static boost::shared_ptr<std::string> KEY_INVITATION_PARAMS;
