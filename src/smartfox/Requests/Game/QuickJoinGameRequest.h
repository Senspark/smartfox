...
namespace Game {
	...
	public:
		...
		/// <summary>
		/// <see cref=" QuickJoinGameRequest(boost::shared_ptr<MatchExpression>, boost::shared_ptr<std::vector<std::string>>, boost::shared_ptr<Room>)"/>
		/// </summary>
		QuickJoinGameRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<std::string>> whereToSearch);
		...
		///
		///			boost::shared_ptr<std::string> value (new std::string("Darts"));
		...
		///			boost::shared_ptr<std::vector<boost::shared_ptr<std::string>>> whereToSearch (new vector<boost::shared_ptr<std::string>>);
		...
		QuickJoinGameRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<std::string>> whereToSearch, boost::shared_ptr<Room> roomToLeave);

		/// <summary>
		/// <see cref=" QuickJoinGameRequest(boost::shared_ptr<MatchExpression>, boost::shared_ptr<std::vector<boost::shared_ptr<Room> > >, boost::shared_ptr<Room>)"/>
		/// </summary>
		QuickJoinGameRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<boost::shared_ptr<Room> > > whereToSearch);
		...
		QuickJoinGameRequest(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<boost::shared_ptr<Room> > > whereToSearch, boost::shared_ptr<Room> roomToLeave);
		...
		static boost::shared_ptr<std::string> KEY_ROOM_LIST;
		
		static boost::shared_ptr<std::string> KEY_GROUP_LIST;
		
		static boost::shared_ptr<std::string> KEY_ROOM_TO_LEAVE;
		
		static boost::shared_ptr<std::string> KEY_MATCH_EXPRESSION;
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<std::string>> whereToSearch, boost::shared_ptr<Room> roomToLeave);
		void Init(boost::shared_ptr<MatchExpression> matchExpression, boost::shared_ptr<std::vector<boost::shared_ptr<Room> > > whereToSearch, boost::shared_ptr<Room> roomToLeave);

		// -------------------------------------------------------------------
		// Private members
		// -------------------------------------------------------------------
		boost::shared_ptr<std::vector<boost::shared_ptr<Room> > > whereToSearchRoom;
		boost::shared_ptr<std::vector<std::string>> whereToSearchString;
