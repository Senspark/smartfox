...
namespace Game {
	...
	public:
		...
		JoinRoomInvitationRequest(const boost::shared_ptr<Room>& targetRoom, boost::shared_ptr<list<string> > invitedUserNames, boost::shared_ptr<ISFSObject> parameters, long int expirySeconds, bool asSpectator);
		...
		/// </summary>
		JoinRoomInvitationRequest(const boost::shared_ptr<Room>& targetRoom, boost::shared_ptr<list<string> > invitedUserNames, boost::shared_ptr<ISFSObject> parameters, long int expirySeconds);

		/// <summary>
		/// See <em>JoinRoomInvitationRequest(boost::shared_ptr&lt;Room&gt;, boost::shared_ptr&lt;list&lt;string&gt; &gt;, boost::shared_ptr&lt;ISFSObject&gt;, long int, bool)</em> constructor.
		/// </summary>
		JoinRoomInvitationRequest(const boost::shared_ptr<Room>& targetRoom, boost::shared_ptr<list<string> > invitedUserNames, boost::shared_ptr<ISFSObject> parameters);

		/// <summary>
		/// See <em>JoinRoomInvitationRequest(boost::shared_ptr&lt;Room&gt;, boost::shared_ptr&lt;list&lt;string&gt; &gt;, boost::shared_ptr&lt;ISFSObject&gt;, long int, bool)</em> constructor.
		/// </summary>
		JoinRoomInvitationRequest(const boost::shared_ptr<Room>& targetRoom, boost::shared_ptr<list<string> > invitedUserNames);
		...
		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_EXPIRY_SECONDS;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_INVITED_NAMES;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_AS_SPECT;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_OPTIONAL_PARAMS;
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(const boost::shared_ptr<Room>& targetRoom, boost::shared_ptr<list<string> > invitedUserNames, boost::shared_ptr<ISFSObject> parameters, long int expirySeconds, bool asSpectator);
