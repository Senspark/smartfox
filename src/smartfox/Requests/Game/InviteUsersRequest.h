...
namespace Game {
	...
	public:
		...
		static boost::shared_ptr<std::string> KEY_INVITATION_ID;
		
		static boost::shared_ptr<std::string> KEY_TIME;
		
		static boost::shared_ptr<std::string> KEY_PARAMS;
		
		static boost::shared_ptr<std::string> KEY_INVITEE_ID;
		
		static boost::shared_ptr<std::string> KEY_INVITED_USERS;
		
		static boost::shared_ptr<std::string> KEY_REPLY_ID;
