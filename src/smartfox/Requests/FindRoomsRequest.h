...
namespace Requests {
	...
	public:
		...
		/// <see cref="FindRoomsRequest(boost::shared_ptr<MatchExpression>, string, long int) "/>
		/// </summary>
		FindRoomsRequest(boost::shared_ptr<MatchExpression> expr, const std::string& groupId);
		...
		///					boost::shared_ptr<std::vector<boost::shared_ptr<Room>> ptrNotifiedRooms = ((boost::static_pointer_cast<std::vector<boost::shared_ptr<Room>>)(ptrEventParamValueRooms));
		///				}
		/// 	\endcode
		/// </example>
		...
		FindRoomsRequest(boost::shared_ptr<MatchExpression> expr, const std::string& groupId, long int limit);
		...
		static boost::shared_ptr<std::string> KEY_FILTERED_ROOMS;
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(boost::shared_ptr<MatchExpression> expr, const std::string& groupId, long int limit);
