...
namespace Requests {
	...
	public:
		...
		///
		///			boost::shared_ptr<std::string> value1(new std::string("Snooker"));
		...
		///					boost::shared_ptr<std::vector<string>> changedVars = ((boost::static_pointer_cast<std::vector<string>>)(ptrEventParamValueVars));
		///
		...
		/// 	\endcode
		/// </example>
		SetRoomVariablesRequest (boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > roomVariables, boost::shared_ptr<Room> room);

		/// <summary>
		/// <see cref="SetRoomVariablesRequest(vector<RoomVariable*>*, Room*)"/>
		/// </summary>
		SetRoomVariablesRequest (boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > roomVariables);
		...
		static boost::shared_ptr<std::string> KEY_VAR_ROOM;

		static boost::shared_ptr<std::string> KEY_VAR_LIST;
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init (boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > roomVariables, boost::shared_ptr<Room> room);

		// -------------------------------------------------------------------
		// Private members
		// -------------------------------------------------------------------
		boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > roomVariables;
