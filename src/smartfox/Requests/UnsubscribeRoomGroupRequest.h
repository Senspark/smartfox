...
public:
    ...
    /// <example>
    ///        \code{.cpp}
    ///                ptrSmartFox->AddEventListener(SFSEvent::ROOM_GROUP_UNSUBSCRIBE,
    /// boost::shared_ptr<EventListenerDelegate>
    ///(EventListenerDelegate(CMyClass::OnUnsubscribeRoomGroup, (unsigned long
    /// long)this));
    ///                ptrSmartFox->AddEventListener(SFSEvent::ROOM_GROUP_UNSUBSCRIBE_ERROR,
    /// boost::shared_ptr<EventListenerDelegate>
    ///(EventListenerDelegate(CMyClass::OnUnsubscribeRoomGroupError, (unsigned
    /// long long)this));
    ///
    ///                boost::shared_ptr<IRequest> request (new
    /// UnsubscribeRoomGroupRequest("CardGames"));
    ///                ptrSmartFox->Send(request);
    ///
    ///                static void OnUnsubscribeRoomGroup(unsigned long long
    ///                ptrContext,
    /// boost::shared_ptr<BaseEvent> ptrEvent);                 static void
    /// OnUnsubscribeRoomGroupError(unsigned long long ptrContext,
    /// boost::shared_ptr<BaseEvent> ptrEvent);
    ///
    ///                void CMyClass::OnUnsubscribeRoomGroup(unsigned long long
    ///                ptrContext,
    /// boost::shared_ptr<BaseEvent> ptrEvent);
    ///                {
    ...
    ///                    boost::shared_ptr<void> ptrEventParamValueGroupId =
    ///(*ptrEventParams)["groupId"];
    ///                    boost::shared_ptr<std::string> ptrGroupId =
    ///((boost::static_pointer_cast<string>)(ptrEventParamValueGroupId));
    ///                    string* message = new std::string("Group Removed: " +
    ///(*ptrGroupId));
    ///                }
    ///
    ///                void CMyClass::OnUnsubscribeRoomGroupError(unsigned long
    ///                long
    ...
    ///                    string* message = new std::string("Unsubscribe failure: "
    ///                    +
    ///(*ptrErrorMessage));
    ///                }
    ///     \endcode
    ...
    explicit UnsubscribeRoomGroupRequest(const std::string& groupId);

    virtual ~UnsubscribeRoomGroupRequest() override;
