...
// Constructor
// -------------------------------------------------------------------
RoomSettings::RoomSettings(const std::string& name)
{
	// Default settings
	...
	this->maxVariables = 5;
	this->groupId = boost::shared_ptr<std::string>(new std::string(*SFSConstants::DEFAULT_GROUP_ID));
	this->variables = boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > >();
...
RoomSettings::~RoomSettings()
{
	...
	{
		variables->clear();
		variables = boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > >();
	}
}
...
// Name
// -------------------------------------------------------------------
boost::shared_ptr<std::string> RoomSettings::Name()
{
	return this->name;
}
...
// Name
// -------------------------------------------------------------------
void RoomSettings::Name(const std::string& value)
{
	this->name = boost::shared_ptr<std::string> (new std::string(value));
}

// -------------------------------------------------------------------
// Password
// -------------------------------------------------------------------
boost::shared_ptr<std::string> RoomSettings::Password()
{
...
// Password
// -------------------------------------------------------------------
void RoomSettings::Password(const std::string& value)
{
	this->password = boost::shared_ptr<std::string> (new std::string(value));
}
...
// Variables
// -------------------------------------------------------------------
boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > RoomSettings::Variables()
{
...
// Variables
// -------------------------------------------------------------------
void RoomSettings::Variables(boost::shared_ptr<std::vector<boost::shared_ptr<RoomVariable> > > value)
{
...
// GroupId
// -------------------------------------------------------------------
boost::shared_ptr<std::string> RoomSettings::GroupId()
{
	return this->groupId;
}
...
// GroupId
// -------------------------------------------------------------------
void RoomSettings::GroupId(const std::string& value)
{
	this->groupId = boost::shared_ptr<std::string>(new std::string(value));
}
