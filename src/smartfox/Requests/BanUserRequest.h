...
namespace Requests {
	...
	public:
		...
		/// <see cref="BanUserRequest(long int, string, BanMode, long int, long int)"/>
		/// </summary>
		BanUserRequest(long int userId, const std::string& message);

		/// <summary>
		/// <see cref="BanUserRequest(long int, string, BanMode, long int, long int)"/>
		/// </summary>
		BanUserRequest(long int userId, const std::string& message, BanMode banMode);

		/// <summary>
		/// <see cref="BanUserRequest(long int, string, BanMode, long int, long int)"/>
		/// </summary>
		BanUserRequest(long int userId, const std::string& message, BanMode banMode, long int delaySeconds);
		...
		///		\endcode
		///	</example>
		BanUserRequest(long int userId, const std::string& message, BanMode banMode, long int delaySeconds, long int durationHours);
		...
		static boost::shared_ptr<std::string> KEY_USER_ID;
		
		static boost::shared_ptr<std::string> KEY_MESSAGE;

		static boost::shared_ptr<std::string> KEY_DELAY;
		
		static boost::shared_ptr<std::string> KEY_BAN_MODE;
		
		static boost::shared_ptr<std::string> KEY_BAN_DURATION_HOURS;		
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(long int userId, const std::string& message, BanMode banMode, long int delaySeconds, long int durationHours);
