...
// Constructor
// -------------------------------------------------------------------
ObjectMessageRequest::ObjectMessageRequest(boost::shared_ptr<ISFSObject> obj, boost::shared_ptr<Room> targetRoom, boost::shared_ptr<std::vector<boost::shared_ptr<User> > > recipients)
{
...
ObjectMessageRequest::ObjectMessageRequest(boost::shared_ptr<ISFSObject> obj, boost::shared_ptr<Room> targetRoom)
{
	...
	this->recipientRoom = boost::shared_ptr<Room>();
	this->recipientString = boost::shared_ptr<std::string>();
	this->recipientUsersCollection = boost::shared_ptr<std::vector<boost::shared_ptr<User> > >();
}
