...
namespace Buddylist {
	...
	public:
		...
		// Public methods
		// -------------------------------------------------------------------
		BuddyMessageRequest(const std::string& message, boost::shared_ptr<Buddy> targetBuddy);
		...
		///				{
		///					string* message = new std::string("I said: " +  (*ptrNotifiedMessage));
		///				}
		///				else
		///				{
		///					string* message = new std::string("Buddy said: " +  (*ptrNotifiedMessage));
		///				}
		///			}
		/// 	\endcode
		/// </example>
		...
		BuddyMessageRequest(const std::string& message, boost::shared_ptr<Buddy> targetBuddy, boost::shared_ptr<ISFSObject> parameters);
