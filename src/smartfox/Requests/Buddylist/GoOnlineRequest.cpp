...
boost::shared_ptr<std::string> GoOnlineRequest::KEY_ONLINE (new std::string("o"));
boost::shared_ptr<std::string> GoOnlineRequest::KEY_BUDDY_NAME (new std::string("bn"));
boost::shared_ptr<std::string> GoOnlineRequest::KEY_BUDDY_ID (new std::string("bi"));
...
// Validate
// -------------------------------------------------------------------
void GoOnlineRequest::Validate(const boost::shared_ptr<SmartFox>& sfs)
{
	...
	if (errors->size() > 0)
	{
		boost::shared_ptr<std::string> message (new std::string("GoOnline request error"));
...
// Execute
// -------------------------------------------------------------------
void GoOnlineRequest::Execute(const boost::shared_ptr<SmartFox>& sfs)
{
	/*
