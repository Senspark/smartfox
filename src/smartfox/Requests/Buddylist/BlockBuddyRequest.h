...
namespace Buddylist {
	...
	public:
		...
		BlockBuddyRequest(const std::string& buddyName, bool blocked);
		...
		static boost::shared_ptr<std::string> KEY_BUDDY_NAME;

		static boost::shared_ptr<std::string> KEY_BUDDY_BLOCK_STATE;

		static boost::shared_ptr<std::string> KEY_BUDDY;
