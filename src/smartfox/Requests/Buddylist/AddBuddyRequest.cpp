...
boost::shared_ptr<std::string> AddBuddyRequest::KEY_BUDDY_NAME (new std::string("bn"));

// -------------------------------------------------------------------
// Constructor
// -------------------------------------------------------------------
AddBuddyRequest::AddBuddyRequest(const std::string& buddyName)
...
// Validate
// -------------------------------------------------------------------
void AddBuddyRequest::Validate(const boost::shared_ptr<SmartFox>& sfs)
{
...
// Execute
// -------------------------------------------------------------------
void AddBuddyRequest::Execute(const boost::shared_ptr<SmartFox>& sfs)
{
