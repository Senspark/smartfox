...
boost::shared_ptr<std::string> BlockBuddyRequest::KEY_BUDDY_NAME (new std::string("bn"));
boost::shared_ptr<std::string> BlockBuddyRequest::KEY_BUDDY_BLOCK_STATE (new std::string("bs"));
boost::shared_ptr<std::string> BlockBuddyRequest::KEY_BUDDY(new std::string("bd"));

// -------------------------------------------------------------------
// Constructor
// -------------------------------------------------------------------
BlockBuddyRequest::BlockBuddyRequest(const std::string& buddyName, bool blocked)
	: BaseRequest (RequestType_BlockBuddy)
{
	this->buddyName = boost::shared_ptr<std::string>(new std::string(buddyName));
...
// Validate
// -------------------------------------------------------------------
void BlockBuddyRequest::Validate(const boost::shared_ptr<SmartFox>& sfs)
{
...
// Execute
// -------------------------------------------------------------------
void BlockBuddyRequest::Execute(const boost::shared_ptr<SmartFox>& sfs)
{
