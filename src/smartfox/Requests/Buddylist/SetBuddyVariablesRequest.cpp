...
boost::shared_ptr<std::string> SetBuddyVariablesRequest::KEY_BUDDY_NAME (new std::string("bn"));
boost::shared_ptr<std::string> SetBuddyVariablesRequest::KEY_BUDDY_VARS (new std::string("bv"));
...
// Validate
// -------------------------------------------------------------------
void SetBuddyVariablesRequest::Validate(const boost::shared_ptr<SmartFox>& sfs)
{
	...
	if (errors->size() > 0)
	{
		boost::shared_ptr<std::string> message (new std::string("SetBuddyVariables request error"));
...
// Execute
// -------------------------------------------------------------------
void SetBuddyVariablesRequest::Execute(const boost::shared_ptr<SmartFox>& sfs)
{
