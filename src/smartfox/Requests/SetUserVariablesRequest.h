...
namespace Requests {
	...
	public:
		...
		///		\code{.cpp}
		///			boost::shared_ptr<std::vector<boost::shared_ptr<UserVariable>>> collectionUserVariable (new vector<boost::shared_ptr<UserVariable>>());
		///
		///			boost::shared_ptr<std::string> value(new std::string("SwedishCook"));
		...
		///
		///			boost::shared_ptr<std::string> value1(new std::string("Sweden"));
		...
		/// </example>
		/// <seealso cref="SFSUserVariable"/>
		SetUserVariablesRequest(boost::shared_ptr<std::vector<boost::shared_ptr<UserVariable> > > userVariables);
		...
		static boost::shared_ptr<std::string> KEY_USER;
	...
	private:
		...
		// Private members
		// -------------------------------------------------------------------
		boost::shared_ptr<std::vector<boost::shared_ptr<UserVariable> > > userVariables;
	};
