...
namespace Requests {
	...
	public:
		...
		SpectatorToPlayerRequest(const boost::shared_ptr<Room>& targetRoom);
		...
		static boost::shared_ptr<std::string> KEY_PLAYER_ID;
	...
	private:
		...
		// Private methods
		// -------------------------------------------------------------------
		void Init(const boost::shared_ptr<Room>& targetRoom);
