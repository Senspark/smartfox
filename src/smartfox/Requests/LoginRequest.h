...
namespace Requests {
	...
	public:
		...
		///					string* message = new std::string("Login failure: " +  (*ptrErrorMessage));
		///				}
		/// 	\endcode
		/// </example>
		...
		LoginRequest(const std::string& userName, const std::string& password, const std::string& zoneName, boost::shared_ptr<ISFSObject> parameters);

		/// <summary>
		/// <see cref="LoginRequest(string, string, string, boost::shared_ptr<ISFSObject>"/>
		/// </summary>
		LoginRequest(const std::string& userName, const std::string& password, const std::string& zoneName);
		...
		static boost::shared_ptr<std::string> KEY_ZONE_NAME;
		
		static boost::shared_ptr<std::string> KEY_USER_NAME;
		
		static boost::shared_ptr<std::string> KEY_PASSWORD;
		
		static boost::shared_ptr<std::string> KEY_PARAMS;
		
		static boost::shared_ptr<std::string> KEY_PRIVILEGE_ID;

		static boost::shared_ptr<std::string> KEY_ID;
		
		static boost::shared_ptr<std::string> KEY_ROOMLIST;
		
		static boost::shared_ptr<std::string> KEY_RECONNECTION_SECONDS;
	...
	private:
		...
		void Init(const std::string& userName, const std::string& password, const std::string& zoneName, boost::shared_ptr<ISFSObject> parameters);

		// -------------------------------------------------------------------
		// Private members
		// -------------------------------------------------------------------

		boost::shared_ptr<std::string> zoneName;
