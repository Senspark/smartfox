...
namespace MMO {
	...
	///
	///		boost::shared_ptr<std::vector<string, boost::shared_ptr<void>>> ptrEventParams = ptrEvent->Params();
	///		boost::shared_ptr<void> ptrEventParamValueAddedUsers = (*ptrEventParams)["addedUsers"];
	///		boost::shared_ptr<std::vector<boost::shared_ptr<User>> ptrNotifiedAddedUsers = ((boost::static_pointer_cast<std::vector<boost::shared_ptr<User>>)(ptrEventParamValueAddedUsers));
	///		boost::shared_ptr<void> ptrEventParamValueRemovedUsers = (*ptrEventParams)["removedUsers"];
	///		boost::shared_ptr<std::vector<boost::shared_ptr<User>> ptrNotifiedRemovedUsers = ((boost::static_pointer_cast<std::vector<boost::shared_ptr<User>>)(ptrEventParamValueRemovedUsers));
    ///
	...
	public:
		...
		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_VEC3D;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_PLUS_USER_LIST;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_MINUS_USER_LIST;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_PLUS_ITEM_LIST;

		/// <exclude/>
		static boost::shared_ptr<std::string> KEY_MINUS_ITEM_LIST;
