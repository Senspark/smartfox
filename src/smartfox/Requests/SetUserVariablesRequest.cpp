...
boost::shared_ptr<std::string> SetUserVariablesRequest::KEY_USER (new std::string("u"));
boost::shared_ptr<std::string> SetUserVariablesRequest::KEY_VAR_LIST (new std::string("vl"));

// -------------------------------------------------------------------
// Constructor
// -------------------------------------------------------------------
SetUserVariablesRequest::SetUserVariablesRequest(boost::shared_ptr<std::vector<boost::shared_ptr<UserVariable> > > userVariables)
...
SetUserVariablesRequest::~SetUserVariablesRequest()
{
	...
	{
		userVariables->clear();
		userVariables = boost::shared_ptr<std::vector<boost::shared_ptr<UserVariable> > >();
	}
}
...
// Validate
// -------------------------------------------------------------------
void SetUserVariablesRequest::Validate(const boost::shared_ptr<SmartFox>& sfs)
{
...
// Execute
// -------------------------------------------------------------------
void SetUserVariablesRequest::Execute(const boost::shared_ptr<SmartFox>& sfs)
{
